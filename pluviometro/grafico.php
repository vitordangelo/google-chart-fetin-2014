	...
	<script type="text/javascript">
		...
		function desenhaGraficoDespesas()
		{
			...
			var options = {
				...
				height: 500,
				title: 'Monitoramento',
				hAxis: {title: 'Hora da Leitura',     titleTextStyle: {color: '#000000'}}, //Título Eixo X
				vAxis: {title: 'Nível de Chuva',  titleTextStyle: {color: '#000000'}}, //Título Eixo Y
